        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brevo-green/20 focus:border-brevo-green transition-all"
            />
            {search && (
              <button
                type="button"
