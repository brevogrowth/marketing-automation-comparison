...
const Index = () => {
  ...
  const testimonial = {
    ...
    company: "Du Bruit dans La Cuisine",
    companyUrl: "https://www.dubruitdanslacuisine.fr/",
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href={testimonial.companyUrl} target="_blank" rel="noopener noreferrer" className="text-dusty-primary hover:text-dusty-primary/80 font-inter text-sm hover:underline">
                          {testimonial.company}
                        </a>
                      </div>
                    </div>
